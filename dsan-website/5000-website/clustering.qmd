...
I cannot use python for now in VScode for now due to the limitations of data set size in VScode, it is quite challenging to handle my data in VScode, and it is obviously harder to do it in R since we do have lots of coding examples from class.
